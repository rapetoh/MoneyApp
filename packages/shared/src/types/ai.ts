...
export interface AskMurmurTransaction {
  ...
  /** The recurring rule this transaction was generated by / linked to, when
   *  any — lets the tools answer "which payments belong to 20 LLC" by the
   *  real link instead of by name (Aug 16: a "The20 MSP" deposit linked to
   *  the "20 LLC" rule was attributed to The20 by name). */
